  ...
  return (
    <>
      ...
      {isProactiveBubble && !isOpen && (
        <div
          className="fixed bottom-24 left-6 z-40 max-w-[220px] bg-onyx-light border border-champagne/30 text-cream/80 text-sm px-4 py-3 rounded-2xl rounded-bl-none shadow-xl animate-slide-up cursor-pointer"
          onClick={handleOpen}
        >
          {t('proactive')}
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-40 w-12 h-12 rounded-full bg-onyx-light border border-champagne/40 text-champagne flex items-center justify-center hover:scale-110 hover:bg-champagne/10 transition-all duration-300 shadow-lg"
      ...
      <div
        ...
        className={`fixed bottom-24 left-6 z-40 w-80 sm:w-96 flex flex-col bg-onyx-light border border-onyx-border rounded-3xl shadow-2xl overflow-hidden transition-all duration-400 ease-out-expo origin-bottom-left ${
          isOpen
